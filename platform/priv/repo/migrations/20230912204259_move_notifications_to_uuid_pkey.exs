defmodule Platform.Repo.Migrations.MoveNotificationsToUuidPkey do
  use Ecto.Migration
  ...
  def up do
    ...
    rename table("notifications"), :id, to: :deprecated_integer_id
    rename table("notifications"), :uuid, to: :id
