defmodule Platform.Repo.Migrations.FixCustomAttributesInSearch do
  use Ecto.Migration
  ...
  def change do
    ...
    execute(
      ...
      GENERATED ALWAYS AS (
        ...
        ) || to_tsvector('english', auto_metadata) || to_tsvector('english', coalesce(project_attributes, '[]'::jsonb))
      ) STORED
      """
      |> String.replace("\n", " "),
      "ALTER TABLE media DROP COLUMN searchable"
