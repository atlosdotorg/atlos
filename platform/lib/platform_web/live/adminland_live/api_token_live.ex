          ...
          <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                  ...
                  <thead class="bg-white">
                    <tr>
                      ...
                      <th scope="col" class="py-3.5 pl-3 pr-4 sm:pr-6">
                        ...
                        <.link method = "New Token" class = "button ~urge @high float-right" patch = {Routes.adminland_index_path(@socket, :api_new)}></.link>
                      </th>
                    </tr>
                  </thead>
            ...
            <% else %>
              <div class="text-center">
                ...
                <div class="mt-6">
                  <.link method = "New Token" class = "button ~urge @high" patch =  {Routes.adminland_index_path(@socket, :api_new)}></.link>
                </div>
              </div>
            <% end %>
