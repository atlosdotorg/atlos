        ...
        <article class="w-full h-full xl:max-w-screen-xl md:mx-auto px-4">
          <div class="pt-4 w-full flex flex-col md:flex-row md:justify-between gap-4 md:items-center">
            <div>
              ...
              <p class="text-neutral-500 prose mt-6">
                <%= @project.description |> Platform.Utils.render_markdown() %>
              </p>
            </div>
          ...
          <nav class="flex space-x-8 mt-8" aria-label="Tabs">
            <% inactive_classes =
            ...
            <%= if Projects.can_edit_project?(@current_user, @project) do %>
              ...
              >
                <Heroicons.pencil mini class="opacity-75 -ml-0.5 mr-2 h-5 w-5" />
                <span>Manage</span>
              </.link>
            <% end %>
