    ...
    [
      ...
      %Attribute{
        ...
        options: [
          ...
          "Civilian Vehicle/Train",
          "Civilian Vehicle/Bus",
          "Civilian Vehicle/Aircraft",
          "Civilian Vehicle/Boat",
          "Injury",
          "Injury/Civilian",
          "Injury/Soldier",
          "Death",
      ...
      %Attribute{
        ...
        options: [
          ...
          "Military Aircraft/Drone"
        ],
        label: "Equipment",
        description:
          "What equipment — weapon, military infrastructure, etc. — is involved in the incident?",
        pane: :attributes,
        required: false,
        name: :equipment,
        add_none: "None"
